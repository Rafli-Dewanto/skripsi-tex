...
\lstdefinelanguage{TypeScript}{
  keywords={
    typeof, new, true, false, catch, function, return, null, switch, var, let, const,
    if, in, while, do, else, case, break, for, continue, of, async, await, yield, try, throw
  },
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={
    class, export, boolean, number, string, interface, type, implements, import, this,
    public, private, protected, readonly, namespace, enum, any, unknown, never, void
  },
  ndkeywordstyle=\color{darkgray}\bfseries,
  identifierstyle=\color{black},
  sensitive=true,
...
\listofappendices
\input{components/bab-1.tex}
\input{components/bab-2.tex}
\input{components/bab-3.tex}
\input{components/bab-4.tex}
\input{components/bab-5.tex}
\clearpage
\phantomsection
